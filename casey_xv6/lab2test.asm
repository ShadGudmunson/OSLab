...
int main (int argc, char *argv[]) {
  ...
  15:	6a 0d                	push   $0xd
  17:	6a 01                	push   $0x1
  19:	e8 3d 03 00 00       	call   35b <set_priority>
  ...
  25:	e8 39 03 00 00       	call   363 <get_priority>

	if (check < 0 || check > 39) { //Check to see if nice value is in range.
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	83 f8 27             	cmp    $0x27,%eax
  30:	77 0f                	ja     41 <main+0x41>
